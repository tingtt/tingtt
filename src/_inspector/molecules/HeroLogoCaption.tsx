...
export const HeroLogoCaption = () => {
  return (
    <div className='relative flex items-center gap-8 sm:gap-16 pr-16 w-full max-w-full'>
      <div className='flex items-center w-8 sm:w-auto h-0 overflow-visible'>
        <div className='scale-[0.5] sm:scale-[0.7] lg:scale-[0.8] xl:scale-[0.9] 2xl:scale-100 rotate-45'>
          <BugRoad />
        </div>
      </div>
      <div className='z-10'>
